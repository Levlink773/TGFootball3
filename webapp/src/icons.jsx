...
// Щит з короною для ВІП-картки. Растр art['vip'] тут не годиться: він на
// непрозорому темно-синьому квадраті, тож поруч із текстом читається як сіра
// плитка. currentColor-SVG до того ж підхоплює золоте свічення.
export const IconVipShield = (p) => (
  <I {...p}>
    <path d="M12 3 5 5.8v5.4c0 4.6 3 7.9 7 9.8 4-1.9 7-5.2 7-9.8V5.8L12 3Z" />
    <path d="M8.6 13.2 8 8.9l2 1.6L12 8l2 2.5 2-1.6-.6 4.3H8.6Z" />
