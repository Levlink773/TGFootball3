...
from webapp_api.routers.inventory import inventory_router
from webapp_api.routers.quests import quests_router
from webapp_api.routers.character import character_router
